...
//           (attrName = dataAttrs[i].name), "data-" ===
//             attrName.substring(0, 5) &&
...
//       ), (jQuery.browser = browser), ($.fn.preloadImg = function(src, _event) {
//       return this.each(function() {
//         var $this = $(this),
//           self = this,
//           img = new Image();
//         (img.onload = function(event) {
//           null == event && (event = {}), $this.attr("src", src), (event.width =
//             img.width), (event.height = img.height), $this.data(
//             "width",
//             img.width
//           ), $this.data("height", img.height), setTimeout(function() {
...
//       { target: this },
//       this.__touchStart
//     ), ($element[0].swipe = this), (this.onSwipe = null), (this.swipeType =
//       "horizontal"), (this.noSwipeSelector =
//       "input, textarea, button, .no-swipe, .ms-no-swipe"), (this.lastStatus = {});
//   };
...
//       temp_y,
//       status_data = {};
//     return (temp_x = this.lastStatus.distanceX || 0), (temp_y =
//       this.lastStatus.distanceY || 0), (status_data.distanceX =
//       evt.pageX - this.start_x), (status_data.distanceY =
//       evt.pageY - this.start_y), (status_data.moveX =
//       status_data.distanceX - temp_x), (status_data.moveY =
//       status_data.distanceY - temp_y), (status_data.distance = parseInt(
//       Math.sqrt(
...
//     (this.reset = !1), (this.lastStatus = {}), (this.start_time = new Date().getTime()), (this.start_x = isTouch
...
//       swipe.enabled &&
//       !(
//         $(event.target).closest(swipe.noSwipeSelector, swipe.$element).length >
//         0
//       )
//     ) {
//       if (
...
//         jqevt.preventDefault(), (status.phase =
//         "move"), (swipe.lastStatus = status), swipe.onSwipe.call(null, status);
//     }
...
//       swipe.lastStatus
//     );
//     isTouch || jqevt.preventDefault(), (status.phase =
//       "end"), (swipe.touchStarted = !1), (swipe.priventEvt = null), $(document)
//       .unbind(ev_end, swipe.__touchEnd)
//       .unbind(ev_move, swipe.__touchMove)
//       .unbind(ev_cancel, swipe.__touchCancel), (status.speed =
//       status.distance / status.duration), swipe.onSwipe.call(null, status);
...
//     return list.push([listener, ref]), 1 === list.length && st.start(), (len =
//       list.length);
...
//     (this.$element = element), (this.duration = duration || 1e3), (this.delay =
//       delay || 0), (this.ease = ease || "linear");
//   };
...
//     (this.$container = $container), (this.$img = $img), (this.type =
//       type || "stretch"), (this.widthOnly = !1), (this.heightOnly = !1);
//   };
...
//                   (self.value = value),
//                   self._callrenderer()
//                 ), (self.animating = !1), active_id !== self.__animID &&
//                 (self.__animID = -1), void self._callonComplete("anim");
//             window.requestAnimationFrame(tick), (self.value =
//               targetPosition -
//               amplitude *
...
//         (this.start_drag = !1)
//       ), (this.animating = !1), (this._deceleration = !1), (this.value -= move), !this
//       .options.endless &&
...
//     }
//     (this.animating = !1), (this.__needsSnap =
//       this.options.endless ||
//       (this.end_loc > this._min_value && this.end_loc < this._max_value)), this
//       .options.snapping &&
//       this.__needsSnap &&
...
//         : this.value > this._max_value &&
//           (out_value = this._max_value - this.value), (this.__isout =
//         Math.abs(out_value) >= this.options.minValidDist), this.__isout &&
...
//     (this.slide = slide), (this.slider =
//       slide.slider), (this.layers = []), (this.layersCount = 0), (this.preloadCount = 0), (this.$layers = $(
//       "<div></div>"
...
//     }
//     layer.create(), this.layers.push(layer), this
//       .layersCount++, layer.parallax &&
...
//     this.layersHideTween && this.layersHideTween.stop(!0), this
//       .fixedLayersHideTween &&
...
//             return (r[transform_css] =
//               "translateX(" + -dist * st.rf + "px)"), r;
//           }
//         : function(dist, fade) {
//             var r = fade === !1 ? {} : { opacity: 0 };
...
//         : function(leftdis, topdis, fade) {
//             var r = fade === !1 ? {} : { opacity: 0 };
//             return (r.top = topdis * st.rf + "px"), (r.left =
//               leftdis * st.rf + "px"), r;
//           }), (st.rotate = _2d
//         ? function(deg, orig) {
//             var r = { opacity: 0 };
...
//             var trans_origin = "";
//             return (trans_origin +=
//               "n" !== ox ? ox + "% " : "50% "), (trans_origin +=
//               "n" !== oy ? oy + "% " : "50% "), (trans_origin +=
//               "n" !== oz ? oz + "px" : ""), (_r[
//               transform_orig_css
//             ] = trans_origin), _r;
//           }
...
//       ease: "linear",
//       delay: 0
//     }), (this.end_anim = { duration: 1e3, ease: "linear" }), (this.type =
//       "text"), (this.resizable = !0), (this.minWidth = -1), (this.isVisible = !0), (this.__cssConfig = [
//       "margin-top",
//       "padding-top",
//       "margin-bottom",
//       "padding-left",
...
//     }
//     this.middleAlign && (this.baseHeight = this.$element.outerHeight(!1)), this
//       .centerAlign && (this.baseWidth = this.$element.outerWidth(!1));
//   }), (p.locate = function() {
//     if (this.slide.ready) {
//       var factor,
//         isPosition,
...
//         this.$element
//           .css("display", "")
//           .css("visibility", "hidden"), (factor = this.resizeFactor =
...
//           "bottom" === key ||
//           "right" === key), (factor =
//           this.fixed && isPosition ? 1 : this.resizeFactor), (this.resizable ||
//           isPosition) &&
...
//       }, that.start_anim.delay || 0.01)), (this.clTo = setTimeout(function() {
//         that.show_cl = !0;
//       }, (this.start_anim.delay || 0.01) + this.start_anim.duration)), this
//         .autoHide &&
//         (
...
//     var options = {};
//     animation.ease && (options.ease = animation.ease), (options.transProperty =
//       window._csspfx + "transform,opacity"), (this.show_tween = CTween.animate(
//       this.$element,
//       animation.duration,
//       css,
//       options
...
//       x_def
//     ) < 0.019 && (this._lastParaX = this._paraX), Math.abs(y_def) < 0.019 &&
...
//           this._lastParaY * this.parallax +
//           "px"), (this.$parallaxElement[0].style.left =
...
//         .on("load", function() {
//           that
//             .controller.preloadCount--, 0 === that.controller.preloadCount && that.controller._onlayersReady();
//         })
//         .each($.jqLoadFix);
//     }
//     $.browser.msie &&
...
//     MSLayerElement.call(this), this.__cssConfig.push("height"), (this.type =
//       "video");
...
//           )
//         )
//           (this.img_src = this.img.data("src")), this.img.removeAttr(
//             "data-src"
//           );
//         else {
//           var that = this;
...
//       os.left -
//       os2.left -
//       this.slide.slider.$element.scrollLeft()), (this.pos_y =
//       os.top - os2.top - this.slide.slider.$element.scrollTop()), (this.from = {
//       opacity: 0
...
//           parseInt(this.tt.css("max-width"))
//         );
//         (this.base_t = this.pos_y + arrow_h + space), (this.base_l =
//           this.pos_x - w / 2), this.base_l + w > window.innerWidth &&
//           (
//             this.tt_arrow.css(
//               "margin-left",
//               -arrow_w / 2 + this.base_l + w - window.innerWidth + "px"
...
//         break;
//       case "right":
//         (this.base_l = this.pos_x + arrow_w + space), (this.base_t =
//           this.pos_y - this.tt.outerHeight(!1) / 2), window._css3d
//           ? (
//               (this.from[window._jcsspfx + "Transform"] =
//                 "translateX(" + dist + "px)"),
//               (this.to[window._jcsspfx + "Transform"] = "")
...
//       case "left":
//         (this.base_l =
//           this.pos_x - arrow_w - this.tt.outerWidth(!1) - space), (this.base_t =
//           this.pos_y - this.tt.outerHeight(!1) / 2), window._css3d
//           ? (
//               (this.from[window._jcsspfx + "Transform"] =
//                 "translateX(-" + dist + "px)"),
...
//   "ms_changeend"), (MSSliderEvent.WAITING =
//   "ms_waiting"), (MSSliderEvent.AUTOPLAY_CHANGE =
//   "ms_autoplaychange"), (MSSliderEvent.VIDEO_PLAY =
//   "ms_videoPlay"), (MSSliderEvent.VIDEO_CLOSE =
//   "ms_videoclose"), (MSSliderEvent.INIT =
//   "ms_init"), (MSSliderEvent.HARD_UPDATE =
//   "ms_hard_update"), (MSSliderEvent.RESIZE =
//   "ms_resize"), (MSSliderEvent.RESERVED_SPACE_CHANGE =
//   "ms_rsc"), (MSSliderEvent.DESTROY = "ms_destroy"), (function(
//   window,
//   document,
//   $
// ) {
...
//       "ms-slide-loading"
//     )), (this.view = null), (this.index = -1), (this.__width = 0), (this.__height = 0), (this.fillMode =
//       "fill"), (this.selected = !1), (this.pselected = !1), (this.autoAppend = !0), (this.isSleeping = !0), (this.moz =
//       $.browser.mozilla);
//   };
...
//           )
//       ), this.isSleeping || this.setupBG(), CTween.fadeOut(
//       this.$loading,
//       300,
//       !0
...
//       that.$imgcont,
//       that.$bg_img
//     )), (this.bgAligner.widthOnly = this.slider.options.autoHeight), that.slider
//       .options.autoHeight &&
...
//     (this.bgNatrualWidth = event.width), (this.bgNatrualHeight =
//       event.height), (this.bgLoaded = !0), $.browser.msie &&
...
//         (this.autoPauseBgVid = !0), (this.bgvideo_fillmode =
//         $video.data("fill-mode") || "fill"), "none" !== this.bgvideo_fillmode &&
//         (
...
//           )), (this.__height = height), this.$element
//       .width(width)
...
//       ), this.hasLayers && this.layerController.hideLayers(), this.selected &&
//       (
//         (this.selected = !1),
...
//       100
//     )), (this._timer.onTimer = this.onTimer), (this._timer.refrence = this), (this.currentSlide = null), (this.slider = slider), (this.so =
//       slider.options), averta.EventDispatcher.call(this);
//   }), (MSSlideController.registerView = function(name, _class) {
//     if (name in SliderViewList)
//       throw new Error(name + ", is already registered.");
//     SliderViewList[name] = _class;
//   }), (MSSlideController.SliderControlList = {}), (MSSlideController.registerControl = function(
//     name,
//     _class
//   ) {
...
//     };
//     this.so.viewOptions && $.extend(viewOptions, this.so.viewOptions), this.so
//       .autoHeight && (this.so.heightLimit = !1);
...
//       this.currentSlide.unselect(), (this.currentSlide = this.view.currentSlide), this.currentSlide.prepareToSelect(), this
//       .so.endPause &&
...
//       this.__updateWindowHash(), this.dispatchEvent(
//       new MSSliderEvent(MSSliderEvent.CHANGE_START)
//     );
...
//   }), (p.setup = function() {
//     (this.created = !0), (this.paused = !this.so
//       .autoplay), this.view.addEventListener(
...
//     this.dispatchEvent(
//       new MSSliderEvent(MSSliderEvent.DESTROY)
...
//   }), (MasterSlider.author =
//     "Averta Ltd. (www.averta.net)"), (MasterSlider.version =
//     "2.14.6"), (MasterSlider.releaseDate =
//     "May 2015"), (MasterSlider._plugins = []);
//   var MS = MasterSlider;
...
//       )
//     ) {
//       this.$element.addClass("master-slider").addClass("before-init"), $.browser
//         .msie
//         ? this.$element
//             .addClass("ms-ie")
//             .addClass(
...
//       var that = this;
//       $.extend(this.options, options), (this.aspect =
//         this.options.width / this.options.height), (this.$loading = $(
//         "<div></div>"
//       )
...
//         )), this.$loading.parent().css("position", "relative"), this.options
//         .autofill &&
//         ((this.options.fullwidth = !0), (this.options.fullheight = !0)), this
//         .options.fullheight &&
...
// }), (MSViewEvents.SWIPE_START = "swipeStart"), (MSViewEvents.SWIPE_END =
//   "swipeEnd"), (MSViewEvents.SWIPE_MOVE =
//   "swipeMove"), (MSViewEvents.SWIPE_CANCEL =
//   "swipeCancel"), (MSViewEvents.SCROLL = "scroll"), (MSViewEvents.CHANGE_START =
//   "slideChangeStart"), (MSViewEvents.CHANGE_END = "slideChangeEnd"), (function(
//   $
// ) {
//   "use strict";
...
//       this.options,
//       options
//     ), (this.dir = this.options.dir), (this.loop = this.options.loop), (this.spacing = this.options.spacing), (this.__width = 0), (this.__height = 0), (this.__cssProb =
//       "h" === this.dir ? "left" : "top"), (this.__offset =
//       "h" === this.dir ? "offsetLeft" : "offsetTop"), (this.__dimension =
//       "h" === this.dir
//         ? "__width"
...
//       .append(
//         this.$slideCont
//       )), (this.currentSlide = null), (this.index = -1), (this.slidesCount = 0), (this.slides = []), (this.slideList = []), (this.viewSlidesList = []), (this.css3 =
//       window._cssanim), (this.start_buffer = 0), (this.firstslide_snap = 0), (this.slideChanged = !1), (this.controller = new Controller(
//       0,
//       0,
//       {
//         snapping: !0,
...
//         (target_index =
//           this.slidesCount + target_index), (this.index = target_index);
//     } else {
...
//     return (this.__contPos = value), this.dispatchEvent(
//       new MSViewEvents(MSViewEvents.SCROLL)
//     ), this.css3
...
//       (first_slide.$element[0].style[this.__cssProb] =
//         pos + "px"), (first_slide.position = pos);
//     }
...
//         this.spacing -
//         this[this.__dimension];
//       (last_slide.$element[0].style[this.__cssProb] =
//         pos + "px"), (last_slide.position = pos);
//     }
...
//     if ("start" === phase)
//       this.controller.stop(), this.dispatchEvent(
...
//           this.cont_size / 2)
//     )
//       this.controller.drag(status.moveY), this.dispatchEvent(
...
//           this.cont_size / 2)
//     )
//       this.controller.drag(status.moveX), this.dispatchEvent(
//         new MSViewEvents(MSViewEvents.SWIPE_MOVE, status)
//       );
//     else if ("end" === phase || "cancel" === phase) {
...
//       (this.slides = this.__createLoopList()), (this.normalMode =
//       this.slidesCount <= this.options.viewNum);
//     for (var i = 0; i < this.slidesCount; ++i) this.slides[i].create();
//     this.__locateSlides(), (this.controller.options.snapsize =
...
//       ++i
//     )
//       (slide = this.slideList[i]), (distance =
//         -cont_scroll - slide.position), this.__updateSlidesHoriz(
//         slide,
//         distance
//       );
//   }), (p._vertiUpdate = function(controller, value) {
...
//     )
//       (slide = this.slideList[i]), (distance =
//         -cont_scroll - slide.position), this.__updateSlidesVertic(
//         slide,
//         distance
//       );
...
//       .append(slide.$element)), (slide.$element[0].style.position =
//       "relative"), (slide.autoAppend = !1), this.slides.push(
//       slide
//     ), this.slideList.push(slide), this.slidesCount++;
//   }), (p.setSize = function(width, height) {
//     for (var slider = this.slides[0].slider, i = 0; i < this.slidesCount; ++i)
//       (this.slides[i].$frame[0].style.width = width + "px"), slider.options
//         .autoHeight || (this.slides[i].$frame[0].style.height = height + "px");
...
//         this.spacing +
//         this[this.__dimension];
//       (first_slide.$frame[0].style[this.__cssProb] =
//         pos + "px"), (first_slide.position = pos);
//     }
//   }), (p.__pushStart = function() {
//     var last_slide = this.slides.pop(),
...
//         this.spacing -
//         this[this.__dimension];
//       (last_slide.$frame[0].style[this.__cssProb] =
//         pos + "px"), (last_slide.position = pos);
//     }
//   }), (p.__updateViewList = function() {
//     if (this.normalMode) return void (this.viewSlidesList = this.slides);
...
//     )
//       (slide = this.slideList[i]), (distance =
//         -cont_scroll - slide.position), this.__updateSlides(slide, distance);
...
//     var first_slide = this.slides.shift(),
//       last_slide = this.slides[this.slidesCount - 2];
//     this.slides.push(first_slide), (first_slide.position =
//       last_slide.position + this[this.__dimension]);
//   }), (p.__pushStart = function() {
//     var last_slide = this.slides.pop(),
//       first_slide = this.slides[0];
//     this.slides.unshift(last_slide), (last_slide.position =
//       first_slide.position - this[this.__dimension]);
//   }), (p.create = function(index) {
//     _super.create.call(
//       this,
//       index
...
//       this,
//       index
//     ), (this.controller.options.minValidDist = 0.03), (this.__translate =
//       "h" === this.dir ? "translateX" : "translateY");
...
//     MSWaveView.call(this, options), this.$element
//       .removeClass("ms-wave-view")
//       .addClass("ms-focus-view"), (this.options.centerSpace =
//       this.options.centerSpace || 1);
//   }), MSFocusView.extend(
//     MSWaveView
...
//       ), this.options.align &&
//       this.$element.addClass("ms-align-" + this.options.align), this.options
//       .customClass &&
//       this.$element &&
...
//     BaseControl.call(this), (this.options.dir = "h"), (this.options.wheel =
//       "v" ===
//       options.dir), (this.options.arrows = !1), (this.options.speed = 17), (this.options.align = null), (this.options.inset = !1), (this.options.margin = 10), (this.options.space = 10), (this.options.width = 100), (this.options.height = 100), (this.options.type =
//       "thumbs"), (this.options.hover = !1), $.extend(
//       this.options,
//       options
//     ), (this.thumbs = []), (this.index_count = 0), (this.__dimen =
//       "h" === this.options.dir ? "width" : "height"), (this.__alignsize =
//       "h" === this.options.dir ? "height" : "width"), (this.__jdimen =
//       "h" === this.options.dir ? "outerWidth" : "outerHeight"), (this.__pos =
//       "h" === this.options.dir ? "left" : "top"), (this.click_enable = !0);
//   };
...
//             (this.$thumbscont[0].style[this.__pos] = 0.5 * (size - len) + "px"),
...
//     BaseControl.call(this), (this.options.dir =
//       "h"), (this.options.inset = !0), (this.options.margin = 10), (this.options.space = 10), $.extend(
//       this.options,
//       options
//     ), (this.bullets = []);
//   };
...
//     BaseControl.call(this), (this.options.dir =
//       "h"), (this.options.autohide = !0), (this.options.width = 4), (this.options.color =
//       "#3D3D3D"), (this.options.margin = 10), $.extend(
//       this.options,
//       options
//     ), (this.__dimen =
//       "h" === this.options.dir ? "width" : "height"), (this.__jdimen =
//       "h" === this.options.dir ? "outerWidth" : "outerHeight"), (this.__pos =
//       "h" === this.options.dir
//         ? "left"
...
//     }
//   }), (p._resize = function() {
//     (this.vdimen = this.$element[this.__dimen]()), (this.bar_dimen =
...
//     BaseControl.call(
//       this
//     ), (this.options.autohide = !1), (this.options.width = 4), (this.options.color =
//       "#FFFFFF"), (this.options.inset = !0), (this.options.margin = 0), $.extend(
//       this.options,
//       options
//     );
//   };
...
//     BaseControl.call(this), (this.options.color =
//       "#A2A2A2"), (this.options.stroke = 10), (this.options.radius = 4), (this.options.autohide = !1), $.extend(
//       this.options,
//       options
//     );
//   };
...
//       this,
//       options
//     ), (this.options.autohide = !1), (this.options.align = null), (this.options.inset = !1), (this.options.margin = 10), (this.options.size = 100), (this.options.dir =
//       "h"), $.extend(this.options, options), (this.data_list = []);
...
//     }, MSSlideInfo.fadeDuratation)), ele[0].tween &&
//       ele[0].tween.stop(!0), (this.current_ele = ele);
//   }), (p.destroy = function() {
...
//       this.playbtn.addClass("btn-pause"), this.playbtn.click(function() {
//       that.slider.api.paused
...
//       "-" !== this.options.imgSize &&
//       (this.options.imgSize =
//         "_" + this.options.imgSize), (this.options.thumbSize =
//       "_" +
...
//     (this.fade = fade), (this.slider = slider), (this.parallax =
//       parallax / 100), (this.bgparallax =
//       bgparallax / 100), slider.api.addEventListener(
//       MSSliderEvent.INIT,
//       this.init,
//       this
...
//       (this.slider = slider), (this.PId = PId++), this.slider.options
//         .keyboard &&
...
//       (this.PId = PId++), (this.slider = slider), (this.$slider =
//         slider.$element), this.slider.options.startOnAppear &&
...
//       var api = this.slider.api,
//         view = api.view;
//       (this.filters = this.slider.options.filters), (this.slideList =
//         view.slideList), (this.slidesCount =
//         view.slidesCount), (this.dimension =
//         view[view.__dimension]), (this.target =
